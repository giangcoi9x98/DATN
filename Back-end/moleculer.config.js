 ...
 *
 * 	To overwrite broker’s deeply nested default options,
 *  which are not presented in "moleculer.config.js",
 * 	via environment variables, use the `MOL_` prefix and
 *  double underscore `__` for nested properties in .env file.
...
module.exports = {
	...
	// Log formatter for built-in console logger. Available values: default, simple, short.
	// It can be also a `Function`.

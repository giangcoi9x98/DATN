...
module.exports = {
    ...
    async created() {
        ...
        const transaction = async (msg) => {
            let {user_id,profit,currency}=JSON.parse(msg.content.toString())
            ...
            await this.postgres.query(`INSERT INTO crypto_wallet_logs(wallet_id,amount,currency)
             VALUES($1,$2,$3)`, [wallet_id, profit, currency])
        } 
    }
